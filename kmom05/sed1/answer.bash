...
#
# c0b6365dc1e72d9323c115c280d21d6c
# vlinux
# sed1
# v1
# emfh21
...
# v4.0.0 (2019-03-05)
#
# Generated 2022-09-26 11:35:28 by dbwebb lab-utility v4.0.0 (2019-03-05).
...
ANSWER=$(sed -E -n '/192\.168\.0\.1/p' < numbers.txt)
...
ANSWER=$(sed -E -n '/[a-z]{2} a/p' < quotes.txt)
...
ANSWER=$(sed -E -n '/[a-zA-Z]*e[a-zA-Z]*\./p' < quotes.txt)
...
ANSWER=$(sed -E -n '/[a-zA-Z0-9" "!#$%&*+-=?^_`{|}~\/]+@+[a-zA-Z0-9-]{2,10}\.[a-z]{2,10}/p' < emails.txt)
...
ANSWER=$(sed -E 's/home/Asgaard/g;s/Thor/MightyThor/g' < substitution.txt)
...
# home\/Thor\/Pictures\/Family

ANSWER=$(sed -E '5 a \/home\/Thor\/Pictures\/Family\/Thor\/selfie.png' < substitution.txt)
...
ANSWER=$(sed -E -n 's/.*([0-9]{2})\/([A-Za-z]{3})\/([0-9]{4}).+/\3-\2-\1/p' < access-medium.log)

# I will now test your answer - change false to true to get a hint.
assertEqual "2.5" true
